...
{
    [Hotfix]
    public class ScrollContainer:UnrealContainer
    {
        ...
        public override void init()
        {
            ...
            if (this.transform.Find("nodata_text") != null)
                this.noData_text = this.transform.Find("noData_text").GetComponent<Text>();
        ...
        public void onValueDrag()
        {
            ...
            {
                if (topDirection == null || bottomDirection == null)
                    return;
        ...
        {
            bool b = DataCount == 0;
            if (noData != null) noData.gameObject.SetActive(b);
            if (noData_text != null) noData_text.gameObject.SetActive(b);
        }
