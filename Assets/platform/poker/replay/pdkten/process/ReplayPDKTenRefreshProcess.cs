...
{
    public class ReplayPDKTenRefreshProcess : Process
    {
        private PDKTenMatch scene;

        public ReplayPDKTenRefreshProcess(PDKTenMatch scene)
        {
            this.scene = scene;
        }
        ...
        public override void execute()
        {
            ...
            PDKTenMatch.match = PDKTenMatch.match.cloneCardMatch(scene);
