...
namespace XLua.CSObjectWrap
{
    public class XLua_Gen_Initer_Register__
	{
        ...
        static void wrapInit0(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(System.IO.Compression.GZipStream), SystemIOCompressionGZipStreamWrap.__Register);
            ...
            translator.DelayWrapLoader(typeof(System.IO.Compression.CompressionMode), SystemIOCompressionCompressionModeWrap.__Register);
        ...
        static void wrapInit1(LuaEnv luaenv, ObjectTranslator translator)
        {
            ...
            translator.DelayWrapLoader(typeof(cambrian.common.BytesSerializable), cambriancommonBytesSerializableWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UnrealLuaPanel), UnrealLuaPanelWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UnrealLuaSpaceObject), UnrealLuaSpaceObjectWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MouseEventClickProcess), MouseEventClickProcessWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(MouseEventProcess), MouseEventProcessWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(UnityEngineObjectExtention), UnityEngineObjectExtentionWrap.__Register);
        
        
            translator.DelayWrapLoader(typeof(scene.game.Coroutine_Runner), scenegameCoroutine_RunnerWrap.__Register);
