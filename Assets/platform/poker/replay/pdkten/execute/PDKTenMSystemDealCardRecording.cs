...
{
    public class PDKTenMSystemDealCardRecording : Process
    {
        private PDKMSystemDealCardOperate operate;

        private int selfOperate;

        public PDKTenMSystemDealCardRecording(object operate)
        {
        ...
        public override void execute()
        {
            ...
            panel.topView.setMuitplier(PDKTenMatch.match.multiple.boomPoint);     
