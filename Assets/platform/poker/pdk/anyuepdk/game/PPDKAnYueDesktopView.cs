...
{
    public class PPDKAnYueDesktopView : PKDesktopView
    {
        ...
        public override void hideCards(int pos)
        {
            ...
            {
                UnrealRoot.root.getDisplayObject<PPDKAnYueReplayRoomPanel>().gameView.stage.hidePStatus(pos);
            }
            else UnrealRoot.root.getDisplayObject<PDKAnYueRoomPanel>().gameView.stage.hidePStatus(pos);
