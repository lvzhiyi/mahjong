...
{
    public class ReplayPDKRefreshProcess : Process
    {
        private PDKMatch scene;

        public ReplayPDKRefreshProcess(PDKMatch scene)
        {
            this.scene = scene;
        }
        ...
        public override void execute()
        {
            ...
            PDKMatch.match = PDKMatch.match.cloneCardMatch(scene);
