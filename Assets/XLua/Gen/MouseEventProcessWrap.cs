...
namespace XLua.CSObjectWrap
{
    ...
    public class MouseEventProcessWrap 
    {
        public static void __Register(RealStatePtr L)
        {
			ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
			System.Type type = typeof(MouseEventProcess);
        ...
        static int __CreateInstance(RealStatePtr L)
        {
			...
			try {
				...
				if(LuaAPI.lua_gettop(L) == 1)
				{
					...
					MouseEventProcess gen_ret = new MouseEventProcess();
            ...
            return LuaAPI.luaL_error(L, "invalid arguments to MouseEventProcess constructor!");
        ...
        static int _m_OnPointerClick(RealStatePtr L)
        {
		    try {
                ...
                MouseEventProcess gen_to_be_invoked = (MouseEventProcess)translator.FastGetCSObj(L, 1);
        ...
        static int _s_set_sound(RealStatePtr L)
        {
		    try {
                ...
                MouseEventProcess gen_to_be_invoked = (MouseEventProcess)translator.FastGetCSObj(L, 1);
                MouseEventProcess.Sounds gen_value;translator.Get(L, 2, out gen_value);
