...
namespace platform.mahjong
{
    ...
    /// 固定牌区的牌
    /// </summary>
    public class AYMJFixedCards: MJFixedCards
    {
        public AYMJFixedCards() : base()
        {
            cards = new int[0];
        }

        public AYMJFixedCards(int type,int[] cards) : base(type,cards)
        {
        ...
        public override void updateLastCard(int card,int type)
        {
        ...
        public override void deleteCard(int card,int num)
        {
