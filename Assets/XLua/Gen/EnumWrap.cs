...
namespace XLua.CSObjectWrap
{
    ...
    public class SystemIOCompressionCompressionModeWrap
    {
		public static void __Register(RealStatePtr L)
        {
		    ObjectTranslator translator = ObjectTranslatorPool.Instance.Find(L);
		    Utils.BeginObjectRegister(typeof(System.IO.Compression.CompressionMode), L, translator, 0, 0, 0, 0);
			Utils.EndObjectRegister(typeof(System.IO.Compression.CompressionMode), L, translator, null, null, null, null, null);
			
			Utils.BeginClassRegister(typeof(System.IO.Compression.CompressionMode), L, null, 3, 0, 0);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Decompress", System.IO.Compression.CompressionMode.Decompress);
            
            Utils.RegisterObject(L, translator, Utils.CLS_IDX, "Compress", System.IO.Compression.CompressionMode.Compress);
            
			Utils.RegisterFunc(L, Utils.CLS_IDX, "__CastFrom", __CastFrom);
            
            Utils.EndClassRegister(typeof(System.IO.Compression.CompressionMode), L, translator);
        }
        ...
        static int __CastFrom(RealStatePtr L)
		{
            ...
            {
                translator.PushSystemIOCompressionCompressionMode(L, (System.IO.Compression.CompressionMode)LuaAPI.xlua_tointeger(L, 1));
            }
			
            else if(lua_type == LuaTypes.LUA_TSTRING)
            {
			    if (LuaAPI.xlua_is_eq_str(L, 1, "Decompress"))
                {
                    translator.PushSystemIOCompressionCompressionMode(L, System.IO.Compression.CompressionMode.Decompress);
                }
				else if (LuaAPI.xlua_is_eq_str(L, 1, "Compress"))
                {
                    translator.PushSystemIOCompressionCompressionMode(L, System.IO.Compression.CompressionMode.Compress);
                }
				else
                {
                    return LuaAPI.luaL_error(L, "invalid string for System.IO.Compression.CompressionMode!");
                }
            }
			
            else
            {
                return LuaAPI.luaL_error(L, "invalid lua type for System.IO.Compression.CompressionMode! Expect number or string, got + " + lua_type);
            }
